            ...
            <tbody>
                <?php foreach ($users as $user): ?>
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <div class="flex">
                                <img class="w-10 h-10 rounded-full"
                                    src="<?php echo '../../../images/uploads/' . $user['img_path'] ?>"
                                    alt="<?php $user['img_path'] ?>">
                                <div class="ps-3 ml-4 mt-2">
                        ...
                        <td class="px-6 py-4">
                            <a
                                class="edit-button font-medium text-blue-600 dark:text-blue-500 hover:underline mr-2 cursor-pointer"
                                href="editUser.php?user_id=<?php echo $user['id']; ?>">
                                Edit
                            </a>
                            <a data-modal-target="delete-modal" data-modal-toggle="delete-modal"
                                class="delete-button font-medium text-red-600 dark:text-red-500 hover:underline cursor-pointer"
                                href="admin.users.php?user_id=<?php echo $user['id']; ?>">
                                Delete
                            </a>
                        </td>
                    </tr>
