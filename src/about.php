          ...
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li>
              <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                class="inline-flex py-2 pr-4 pl-3 text-orange-500 rounded lg:bg-transparent lg:text-orange-700 lg:p-0 dark:text-white"
                type="button">
                Company
    ...
    <div class="w-full">
      <ul class="flex mb-0 list-none flex-wrap pb-4 flex-row">
        <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
          <a class="text-xs font-bold px-5 uppercase py-3 block leading-normal text-white bg-orange-600 dark:bg-orange-600 cursor-pointer"
            onclick="changeAtiveTab(event,'tab-profile')">
            Who We Are
          </a>
        </li>
        <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
          <a class="text-xs font-bold px-5 uppercase py-3 block leading-normal text-orange-600 bg-gray-100 dark:bg-gray-900 cursor-pointer"
      ...
      <div class="relative flex flex-col min-w-0 break-words bg-gray-100 dark:bg-gray-900 w-full mb-6 rounded">
